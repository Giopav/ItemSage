...
public class DurabilityExecutor extends AbstractDurability implements ExecutorInterface {
    @Override
    ...
    private boolean sendDurability(Player player, ItemStack mainHandItem) {
    ...
    private boolean setDurability(Player player, String[] args, ItemStack mainHandItem) {
    ...
    private Component durabilityMessage(int amount) {
