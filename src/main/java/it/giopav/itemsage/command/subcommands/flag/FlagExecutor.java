...
public class FlagExecutor implements ExecutorInterface {
    @Override
    ...
    private boolean sendFlags(Player player, ItemStack mainHandItem) {
    ...
    private boolean redirectAddOrRemove(Player player, String[] args, ItemStack mainHandItem) {
    ...
    private boolean addFlag(Player player, String[] args, ItemStack mainHandItem) {
        ItemFlag flag = AbstractFlag.getItemFlagValue(args[2]);
        if (flag == null) {
    ...
    private boolean removeFlag(Player player, String[] args, ItemStack mainHandItem) {
        ItemFlag flag = AbstractFlag.getItemFlagValue(args[1]);
        if (flag == null) {
    ...
    private Component flagMessage(ItemFlag flag) {
