...
public class DataExecutor {
    ...
    private static boolean sendData(Player player, ItemStack mainHandItem) {
    ...
    private static boolean removeData(Player player, ItemStack mainHandItem, String[] args) {
    ...
    private static Component dataMessage(NamespacedKey key) {
